...
<body>
    ...
    <div class="servo-container">
        <h1>Servo 4</h1>
        <div class="button-group">
            <button onclick="addServo('servo4',0)">0°</button>
            <button onclick="addServo('servo4',90)">90°</button>
            <button onclick="addServo('servo4',180)">180°</button>
        </div>
        <div class="custom-angle">
            <h3>Custom Angle</h3>
            <input type="number" id="servo4Angle" min="0" max="180" placeholder="0-180">
            <button onclick="setCustomAngle('servo4')">Set Angle</button>
        </div>
    </div>
    ...
    <div class="servo-container">
        <h1>Servo 5</h1>
        <div class="button-group">
            <button onclick="addServo('servo5',0)">0°</button>
            <button onclick="addServo('servo5',90)">90°</button>
            <button onclick="addServo('servo5',180)">180°</button>
        </div>
        <div class="custom-angle">
            <h3>Custom Angle</h3>
            <input type="number" id="servo5Angle" min="0" max="180" placeholder="0-180">
            <button onclick="setCustomAngle('servo5')">Set Angle</button>
        </div>
    </div>
    ...
    <div class="servo-container">
        <h1>Servo 6</h1>
        <div class="button-group">
            <button onclick="addServo('servo6',0)">0°</button>
            <button onclick="addServo('servo6',90)">90°</button>
            <button onclick="addServo('servo6',180)">180°</button>
        </div>
        <div class="custom-angle">
            <h3>Custom Angle</h3>
...
void handleRotateServo() {
  if (server.hasArg("plain")) {
    ...
    if (servoName == "servo1") {
      ...
      Serial.println("Servo 1 set to: " + String(servoAngle));
      delay(1000);
    } else if (servoName == "servo2") {
      servo2.write(servoAngle);
      Serial.println("Servo 2 set to: " + String(servoAngle));
      delay(1000);
    } else if (servoName == "servo3") {
      servo3.write(servoAngle);
      Serial.println("Servo 3 set to: " + String(servoAngle));
      delay(1000);
    }else if (servoName == "servo4") {
      servo4.write(servoAngle);
      Serial.println("Servo 4 set to: " + String(servoAngle));
      delay(1000);
    }else if (servoName == "servo5") {
      servo5.write(servoAngle);
      Serial.println("Servo 5 set to: " + String(servoAngle));
      delay(1000);
    }else if (servoName == "servo6") {
      servo6.write(servoAngle);
      Serial.println("Servo 6 set to: " + String(servoAngle));
      delay(1000);
    }
     else {
